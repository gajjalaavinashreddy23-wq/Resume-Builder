        ...
        <div className="row align-items-start pt-5 pb-5">
          <div className="col-lg-5">
            <h1 className="display-3 fw-bold mb-4">
              Build Smart Resumes That Get You Hired
            </h1>
            <p className="lead mb-4">
              Our AI-powered resume builder tailors your resume to match job
              descriptions, increasing your chances of getting past ATS systems
          ...
          <div className="col-lg-7">
            {import.meta.env.VITE_SHOW_VIDEO === "true" && (
          ...
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm">
              <div className="card-body text-center p-4">
                ...
                <p className="text-muted">
                  Enter your information only for the first use, next time it
                  will be auto-filled
                </p>
              </div>
            </div>
          ...
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm">
              <div className="card-body text-center p-4">
                ...
                <p className="text-muted">
                  Our AI tailors your resume to job descriptions for higher
                  success rates
                </p>
              </div>
            </div>
